...
subheading: draw.io
shortdesc: 流程图软件
description: 支持绘制流程图、UML 图、网络图等多种类型的图表。可以通过在线编辑器，连接各种云存储平台，也可下载独立桌面应用程序以供离线使用。
head:
  - - meta
    - property: og:title
      content: 流程图软件：draw.io
  - - meta
    - property: og:description
      content: 支持绘制流程图、UML 图、网络图等多种类型的图表。可以通过在线编辑器，连接各种云存储平台，也可下载独立桌面应用程序以供离线使用。
  - - meta
    - property: og:url
      content: https://xszn.org/productivity-software/draw.io.html
  - - meta
    - property: og:image
      content: https://xszn.org/images/productivity-software/draw.io/screenshot.webp
  - - meta
...
<Img alt="“draw.io”屏幕截图" src="/images/productivity-software/draw.io/screenshot.webp" />

draw.io 是一款流程图软件。支持绘制流程图、UML 图、网络图等多种类型的图表。可以通过在线编辑器，连接各种云存储平台，也可下载独立桌面应用程序以供离线使用。
...
网站：https://www.drawio.com/

源码：https://github.com/jgraph/drawio-desktop

## 参考资料

1. [diagram-editor - GitHub Topics](https://github.com/topics/diagram-editor)

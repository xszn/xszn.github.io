...
2. [Bulk Crap Uninstaller Documentation - GitHub](https://htmlpreview.github.io/?https://github.com/Klocman/Bulk-Crap-Uninstaller/blob/master/doc/BCU_manual.html)
...
它擅长以最少的用户操作卸载大量应用程序。它可以清理残留文件、检测孤立应用程序、根据预设列表运行卸载程序等等！ -->
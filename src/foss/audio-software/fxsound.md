---
date: 2025-11-22
icon: /images/foss/audio-software/fxsound/favicon.ico
title: 声音增强器：FxSound
subheading: FxSound
shortdesc: 声音增强器
description: 提升电脑音质。可增强音质、音量和低音效果，包含均衡器、效果和预设，方便自定义音频。
head:
  - - meta
    - property: og:title
      content: 声音增强器：FxSound
  - - meta
    - property: og:description
      content: 提升电脑音质。可增强音质、音量和低音效果，包含均衡器、效果和预设，方便自定义音频。
  - - meta
    - property: og:url
      content: https://xszn.org/foss/audio-software/fxsound.html
  - - meta
    - property: og:image
      content: https://xszn.org/images/foss/audio-software/fxsound/screenshot.webp
  - - meta
...
<Img alt="“FxSound”屏幕截图" src="/images/foss/audio-software/fxsound/screenshot.webp" />

FxSound 是一款声音增强器。提升电脑音质。可增强音质、音量和低音效果，包含均衡器、效果和预设，方便自定义音频。
...
网站：https://www.fxsound.com/

源码：https://github.com/fxsound2/fxsound-app

## 参考资料

1. [How To Use FxSound - What is FxSound?](https://www.fxsound.com/course-articles/what-is-fxsound)
...
提升电脑音量和音质。可增强音质、音量和低音效果，包含均衡器、特效和预设，方便您自定义音频。 -->
---
icon: /images/foss/productivity-software/everything/favicon.ico
title: 桌面搜索工具：Everything
subheading: Everything
shortdesc: 桌面搜索工具
description: 基于文件名快速定文件和文件夹位置。在搜索框输入的关键词将会筛选显示的文件和文件夹。
head:
  - - meta
    - property: og:title
      content: 桌面搜索工具：Everything
  - - meta
    - property: og:description
      content: 基于文件名快速定文件和文件夹位置。在搜索框输入的关键词将会筛选显示的文件和文件夹。
  - - meta
    - property: og:url
      content: https://xszn.org/foss/productivity-software/everything.html
  - - meta
    - property: og:image
      content: https://xszn.org/images/foss/productivity-software/everything/screenshot.webp
  - - meta
...
<Img alt="“Everything”屏幕截图" src="/images/foss/productivity-software/everything/screenshot.webp" />

Everything 是一款桌面搜索工具。基于文件名快速定文件和文件夹位置。在搜索框输入的关键词将会筛选显示的文件和文件夹。
...
网站：https://www.voidtools.com/zh-cn/

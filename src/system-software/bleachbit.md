---
date: 2025-11-13
icon: /images/system-software/bleachbit/favicon.ico
...
head:
  ...
  - - meta
    - property: og:url
      content: https://xszn.org/system-software/bleachbit.html
  - - meta
    - property: og:image
      content: https://xszn.org/images/system-software/bleachbit/screenshot.webp
  - - meta
...
<Img alt="“BleachBit”屏幕截图" src="/images/system-software/bleachbit/screenshot.webp" />
...
This is the manual for BleachBit, a fast and safe system cleaner. By simply checking boxes, you can delete unnecessary files such as cache, logs, cookies, recently-used-files lists, and more.
...
BleachBit 可以清理文件，释放磁盘空间并保护隐私。只需勾选相应的复选框，即可删除不必要的文件，例如缓存、日志、Cookie、最近使用的文件列表等等。 -->
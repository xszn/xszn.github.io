...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.p, {
      ...
      label: "Umi-OCR 下载",
      link: "https://hiroi-sora.lanzoul.com/s/umi-ocr",
      style: "solid"
    }), "\n", createVNode(Button, {
      label: "Umi-OCR GitHub 下载",
      link: "https://github.com/hiroi-sora/Umi-OCR/releases/latest",
      style: "solid"
    }), "\n", createVNode(Button, {
      label: "Umi-OCR SourceForge 下载",
      link: "https://sourceforge.net/projects/umi-ocr/",
      style: "solid"
    }), "\n", createVNode(_components.h3, {
      id: "安装",
      children: "安装"
      ...
      children: ["\n", createVNode(_components.li, {
        children: ["普通 ", createVNode(_components.code, {
          children: ".7z"
        }), " 文件需用压缩软件解压。"]
      }), "\n", createVNode(_components.li, {
        children: [createVNode(_components.code, {
          children: ".7z.exe"
        }), " 自解压包，双击即可自动解压，无需额外工具。"]
      }), "\n"]
    }), "\n", createVNode(_components.p, {
      children: createVNode(_components.strong, {
        children: "2. 启动程序"
      ...
      children: ["\n", createVNode(_components.li, {
        children: ["无需安装，解压后直接双击 ", createVNode(_components.code, {
      ...
      children: ["\n", createVNode(_components.li, {
        children: "软件会根据系统语言自动切换界面语言。"
      }), "\n", createVNode(_components.li, {
        children: "可在“全局设置”中手动切换语言、调整主题、字体等。"
      }), "\n"]
    }), "\n", createVNode(_components.h3, {
      id: "使用说明",
      children: "使用说明"

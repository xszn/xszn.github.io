...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.p, {
      ...
      children: "MAS 提供两种下载方式："
    }), "\n", createVNode(_components.ol, {
      children: ["\n", createVNode(_components.li, {
        children: ["\n", createVNode(_components.p, {
          children: createVNode(_components.strong, {
            children: "PowerShell 方法（推荐）"
          })
        }), "\n", createVNode(_components.ul, {
          children: ["\n", createVNode(_components.li, {
            children: "打开 PowerShell 或终端（右键点击开始菜单选择 PowerShell 或终端）。"
          }), "\n", createVNode(_components.li, {
            children: "输入以下命令并按回车："
          }), "\n"]
          ...
          children: createVNode(_components.code, {
            children: createVNode(_components.span, {
              ...
              children: createVNode(_components.span, {
                ...
                children: "https://github.com/massgravel/Microsoft-Activation-Scripts/archive/refs/heads/master.zip"
              })
            })
          })
        }), "\n", createVNode(_components.ul, {
          children: ["\n", createVNode(_components.li, {
            children: ["解压 ZIP 文件后，进入名为 ", createVNode(_components.code, {
              children: "All-In-One-Version"
            }), " 的文件夹。"]
          }), "\n", createVNode(_components.li, {
            children: ["找到并运行 ", createVNode(_components.code, {
              children: "MAS_AIO.cmd"
            }), " 文件。"]
          }), "\n"]
        }), "\n"]
      }), "\n"]
      ...
      children: "MAS 不需要复杂安装，只需运行下载的脚本即可开始使用。对于 PowerShell 方法，直接执行上述命令；对于传统方法，运行解压后的脚本文件即可。"
    }), "\n", createVNode(_components.h3, {
      id: "使用说明",
      children: "使用说明"
    }), "\n", createVNode(Image, {
      ...
      children: ["\n", createVNode(_components.li, {
        children: ["\n", createVNode(_components.p, {
          ...
          children: "在 PowerShell 或传统方法中运行脚本后，根据提示选择激活方式："
        }), "\n", createVNode(_components.ul, {
          children: ["\n", createVNode(_components.li, {
        ...
        children: ["\n", createVNode(_components.p, {
          ...
          children: "如果脚本未能正常运行，请检查以下几点："
        }), "\n", createVNode(_components.ul, {
          children: ["\n", createVNode(_components.li, {
            children: "确保 URL 来源安全可靠。"
          }), "\n", createVNode(_components.li, {
            children: "如果 PowerShell 方法失败，可尝试传统方法。"
          }), "\n", createVNode(_components.li, {
            children: "查看脚本中的蓝色文字提示以获取故障排除步骤。"
          }), "\n"]
        }), "\n"]
      }), "\n"]
    }), "\n", createVNode(Image, {

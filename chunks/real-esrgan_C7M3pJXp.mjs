...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.p, {
      ...
      children: "下载完成后，将压缩包解压到指定文件夹，如“Real-ESRGAN”。如果需要处理视频，建议安装 FFmpeg，这样可以方便地提取和合成视频帧，提升视频处理效果和效率。操作简单，方便使用。"
    }), "\n", createVNode(Tabs, {
      "client:load": true,
      ...
      children: [createVNode(Tab, {
        ...
        children: createVNode(_components.ul, {
          children: ["\n", createVNode(_components.li, {
            ...
            children: "解压后将 bin 文件夹路径添加到环境变量 Path。"
          }), "\n", createVNode(_components.li, {
            children: "最后在命令行输入ffmpeg -version确认安装成功。"
          }), "\n"]
        })
      })]
    }), "\n", createVNode(_components.h3, {
      ...
      src: "/images/posts/2025/04/15/real-tu-xiang-xiu-fu-xiao-guo-tu.webp",
      ...
      children: ["\n", createVNode(_components.li, {
        ...
        children: [createVNode(_components.code, {
          children: "-n"
        }), "：模型名称（默认为 ", createVNode(_components.code, {
      ...
      src: "/images/posts/2025/04/15/real-huo-qu-shi-pin-fps.webp",

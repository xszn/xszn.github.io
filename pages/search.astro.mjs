...
import 'kleur/colors';
import { h as humanize, s as slugify, c as config, $ as $$Base } from '../chunks/_astro_content_BaFZudft.mjs';
...
const $$Search = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "title": `\u641C\u7D22` + config.site.titleDelimiter }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="section"> <div class="container container-page"> ${renderComponent($$result2, "SearchBar", SearchBar, { "client:load": true, "searchList": searchList, "client:component-hydration": "load", "client:component-path": "@/layouts/SearchBar", "client:component-export": "default" })} </div> </section> ` })}`;

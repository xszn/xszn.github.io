/* empty css                                     */
import { b as createAstro, c as createComponent, m as maybeRenderHead, u as unescapeHTML, r as renderComponent, a as renderTemplate, d as addAttribute, e as renderScript } from '../chunks/astro/server_BBoAqXZx.mjs';
import 'kleur/colors';
import { r as renderEntry, m as markdownify, c as config, a as $$Image, h as humanize, s as slugify, $ as $$Base } from '../chunks/_astro_content_DxdUGNXu.mjs';
...
import 'clsx';
import { N as Notice } from '../chunks/Notice_CH83xs3Z.mjs';
...
const $$Comment = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div id="disqus_thread"></div> ${renderScript($$result, "C:/Users/lzl22/OneDrive/Documents/Projects/Website/astro/src/layouts/components/Comment.astro?astro&type=script&index=0&lang.ts")} <noscript>请启用 JavaScript 以查看评论由<a href="https://disqus.com/?ref_noscript">Disqus 提供。</a></noscript>`;
